...
console.log(day);
var my = moment().format("MMM Do YY");
console.log(my);
var date = "2020-01-01";
var aDate = moment(date.value, 'YYYY-MM-DD', true);
console.log(aDate.isValid());
var bDate = "2020-14-01";
var isDate = moment(bDate.value, 'YYYY-MM-DD', true);
console.log(isDate.isValid());
var new_date = moment().add(7, 'days').calendar();
console.log(new_date);
var new_month = moment().add(7, 'month').calendar();
console.log(new_month);
var new_year = moment().add(7, 'year').calendar();
console.log(new_year);
var sub_date = moment().subtract(7, 'days').calendar();
console.log(sub_date);
var sub_month = moment().subtract(7, 'month').calendar();
console.log(sub_month);
var sub_year = moment().subtract(7, 'year').calendar();
console.log(sub_year);
var a = moment("2015-09-11");
var b = moment("2014-11-11");
var final = a.diff(b, "months");
console.log(final);
var a2 = moment("2015-09-16");
var b2 = moment("2014-11-27");
var result = a2.diff(b2, "days");
console.log(result);
...
var dateA = "2010-01-01";
var dateB = "2018-01-01";
...
var arr = ["a", "b", "c", "d"];
var chunked = loadsh.chunk(arr, 2);
console.log(chunked);
var arr2 = ["a", "b", "", 0, false, true, 1, "c"];
var compactedArr = loadsh.compact(arr2);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35617" + '/');
